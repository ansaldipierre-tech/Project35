  ...
  months: [
    {
      monthId: 1,
      monthNameFr: "Mars",
      clueText: "Énigme 1 : INSIDE_JOKE_01",
      hintText: "Indice 1 : SOUVENIR_01",
      extraHints: [
        "EXTRA_INDICE_01_A",
        "EXTRA_INDICE_01_B",
      ],
      ...
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Mars.",
      giftDetails: "DETAIL_CADEAU_01",
      imageUrl: "",
    },
    {
      monthId: 2,
      monthNameFr: "Avril",
      clueText: "Énigme 2 : INSIDE_JOKE_02",
      hintText: "Indice 2 : SOUVENIR_02",
      extraHints: [
        "EXTRA_INDICE_02_A",
        "EXTRA_INDICE_02_B",
      ],
      ...
      revealTitle: "Box Avril",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Avril.",
      giftDetails: "DETAIL_CADEAU_02",
      imageUrl: "",
    },
    {
      monthId: 3,
      monthNameFr: "Mai",
      clueText: "Énigme 3 : INSIDE_JOKE_03",
      hintText: "Indice 3 : SOUVENIR_03",
      extraHints: [
        "EXTRA_INDICE_03_A",
        "EXTRA_INDICE_03_B",
      ],
      ...
      revealTitle: "Box Mai",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Mai.",
      giftDetails: "DETAIL_CADEAU_03",
      imageUrl: "",
    },
    {
      monthId: 4,
      monthNameFr: "Juin",
      clueText: "Énigme 4 : INSIDE_JOKE_04",
      hintText: "Indice 4 : SOUVENIR_04",
      extraHints: [
        "EXTRA_INDICE_04_A",
        "EXTRA_INDICE_04_B",
      ],
      ...
      revealTitle: "Box Juin",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Juin.",
      giftDetails: "DETAIL_CADEAU_04",
      imageUrl: "",
    },
    {
      monthId: 5,
      monthNameFr: "Juillet",
      clueText: "Énigme 5 : INSIDE_JOKE_05",
      hintText: "Indice 5 : SOUVENIR_05",
      extraHints: [
        "EXTRA_INDICE_05_A",
        "EXTRA_INDICE_05_B",
      ],
      ...
      revealTitle: "Box Juillet",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Juillet.",
      giftDetails: "DETAIL_CADEAU_05",
      imageUrl: "",
    },
    {
      monthId: 6,
      monthNameFr: "Août",
      clueText: "Énigme 6 : INSIDE_JOKE_06",
      hintText: "Indice 6 : SOUVENIR_06",
      extraHints: [
        "EXTRA_INDICE_06_A",
        "EXTRA_INDICE_06_B",
      ],
      ...
      revealTitle: "Box Août",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Août.",
      giftDetails: "DETAIL_CADEAU_06",
      imageUrl: "",
    },
    {
      monthId: 7,
      monthNameFr: "Septembre",
      clueText: "Énigme 7 : INSIDE_JOKE_07",
      hintText: "Indice 7 : SOUVENIR_07",
      extraHints: [
        "EXTRA_INDICE_07_A",
        "EXTRA_INDICE_07_B",
      ],
      ...
      revealTitle: "Box Septembre",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Septembre.",
      giftDetails: "DETAIL_CADEAU_07",
      imageUrl: "",
    },
    {
      monthId: 8,
      monthNameFr: "Octobre",
      clueText: "Énigme 8 : INSIDE_JOKE_08",
      hintText: "Indice 8 : SOUVENIR_08",
      extraHints: [
        "EXTRA_INDICE_08_A",
        "EXTRA_INDICE_08_B",
      ],
      ...
      revealTitle: "Box Octobre",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Octobre.",
      giftDetails: "DETAIL_CADEAU_08",
      imageUrl: "",
    },
    {
      monthId: 9,
      monthNameFr: "Novembre",
      clueText: "Énigme 9 : INSIDE_JOKE_09",
      hintText: "Indice 9 : SOUVENIR_09",
      extraHints: [
        "EXTRA_INDICE_09_A",
        "EXTRA_INDICE_09_B",
      ],
      ...
      revealTitle: "Box Novembre",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Novembre.",
      giftDetails: "DETAIL_CADEAU_09",
      imageUrl: "",
    },
    {
      monthId: 10,
      monthNameFr: "Décembre",
      clueText: "Énigme 10 : INSIDE_JOKE_10",
      hintText: "Indice 10 : SOUVENIR_10",
      extraHints: [
        "EXTRA_INDICE_10_A",
        "EXTRA_INDICE_10_B",
      ],
      ...
      revealTitle: "Box Décembre",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Décembre.",
      giftDetails: "DETAIL_CADEAU_10",
      imageUrl: "",
    },
    {
      monthId: 11,
      monthNameFr: "Janvier",
      clueText: "Énigme 11 : INSIDE_JOKE_11",
      hintText: "Indice 11 : SOUVENIR_11",
      extraHints: [
        "EXTRA_INDICE_11_A",
        "EXTRA_INDICE_11_B",
      ],
      ...
      revealTitle: "Box Janvier",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Janvier.",
      giftDetails: "DETAIL_CADEAU_11",
      imageUrl: "",
    },
    {
      monthId: 12,
      monthNameFr: "Février",
      clueText: "Énigme 12 : INSIDE_JOKE_12",
      hintText: "Indice 12 : SOUVENIR_12",
      extraHints: [
        "EXTRA_INDICE_12_A",
        "EXTRA_INDICE_12_B",
      ],
      ...
      revealTitle: "Box Février",
      revealMessage: "Bravo mon cœur 💝 Tu as trouvé la box Février.",
      giftDetails: "DETAIL_CADEAU_12",
      imageUrl: "",
    }
  ],
  moments: [
